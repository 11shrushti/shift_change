...
# Determine the stage from status columns (using new column names)
...
if prev_file and curr_file:
    ...
    # Check that the sheets have the "Email" column
    if "Email" not in prev_df.columns or "Email" not in curr_df.columns:
        ...
        # Merge the sheets on "Email" to determine stage transitions
